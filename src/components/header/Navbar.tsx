...
import { Box, Avatar, Drawer, IconButton, List, ListItem, ListItemButton, ListItemText } from '@mui/material';
    ...
    <NavContainer>
      ...
      {user ? (
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <StyledAvatar component={Link} to="/profile" src={doctorImage || ''} />
        </Box>
      ) : (
        <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
        ...
        >
          ...
          <List>
            <ListItem disablePadding>
              <ListItemButton component={Link} to="/find-a-doctor" onClick={toggleDrawer(false)}>
                <ListItemText primary="Find a Doctor" sx={{ color: '#fff' }} />
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <ListItemButton component={Link} to="/service" onClick={toggleDrawer(false)}>
